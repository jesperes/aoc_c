...
aoc_result_t day7(char *ptr, int len);
aoc_result_t day8(char *ptr, int len);
aoc_result_t day9(char *ptr, int len);
...
aoc_result_t day17(char *ptr, int len);
aoc_result_t day18(char *ptr, int len);
aoc_result_t day19(char *ptr, int len);
aoc_result_t day25(char *ptr, int len);
